...
echo '          <label>Nom du container<input type="text" name="wordpressName" value="wordpress" ></label>'
echo '          <label>Port<input type="text" name="wordpressPort" value="8080" ></label>'
echo '          <label>Mot de passe mysql<input type="password" name="mysqlPass" value="root" ></label>'
echo '        </div>'
