...
echo '        <label for="djangocms"><img src="https://s.w.org/favicon.ico" width="15" height="15">Wordpress</label>'
echo '        <div class="installerMenu" id="wordpressInstaller">'
echo '          <table>'
echo '            <tr>'
echo '              <td><label>Nom du container</label></td>'
echo '              <td><input type="text" name="djangocmsName" value="wordpress" ><td>'
echo '            </tr>'
echo '            <tr>'
echo '              <td><label>Port</label></td>'
